...
/*
 Returns a PlatformImage of the resulting draw. Snapshot should never be called from within the draw method or from a
 thread other than the main thread.
 */
@property (readonly, strong) PlatformImage *snapshot;

/*
 Controls whether the view responds to setNeedsDisplay. If true, then the view behaves similarily to a PlatformView.
